...
class SystemRequirementsPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SystemRequirementsPage> createState() =>
      _SystemRequirementsPage();
}
                  ...
                  Row(
                    ...
                    children: [
                      ElevatedButton.icon(
                        ...
                        onPressed: () {
                          controller
                              .SystemRequirementsController.showAddHeaderDialog(
                            context,
                            ref,
                            username!,
                          );
                      ...
                      ElevatedButton.icon(
                        ...
                        onPressed: () {
                          controller
                              .SystemRequirementsController.showAddRequirementDialog(
                            context,
                            ref,
                            username!,
                          );
                        ...
                        ...items.map((req) {
                          return GestureDetector(
                            onTap: () {
                              ...
                              controller
                                  .SystemRequirementsController.showDetailPopup(
                                username!,
                                context,
                                ref,
                                req,
                                    ...
                                    return Container(
                                      ...
                                      child: Tooltip(
                                        ...
                                        child: GestureDetector(
                                          onTap: () {
                                            controller
                                                .SystemRequirementsController.showAttributeDialog(
                                              context,
                                              ref,
                                              req.id,
                                              h.header,
                                    ...
                                    child:
                                        isAdmin
                                            ? IconButton(
                                              ...
                                              onPressed:
                                                  () => controller
                                                      .SystemRequirementsController.toggleFlag(
                                                    req,
                                                    ref,
                                                  ),
                                            )
