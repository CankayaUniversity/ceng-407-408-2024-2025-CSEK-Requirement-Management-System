...
class UserRequirementsPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<UserRequirementsPage> createState() =>
      _UserRequirementsPageState();
}
                          ...
                          Row(
                            ...
                            children: [
                              ElevatedButton.icon(
                                ...
                                onPressed: () {
                                  controller
                                      .UserRequirementsController.showAddHeaderDialog(
                                    context,
                                    ref,
                                    username!,
                                  );
                              ...
                              ElevatedButton.icon(
                                ...
                                onPressed: () {
                                  controller
                                      .UserRequirementsController.showAddRequirementDialog(
                                    context,
                                    ref,
                                    username!,
                                  );
                              ...
                              ...items.map((req) {
                                return GestureDetector(
                                  onTap: () {
                                    ...
                                    controller
                                        .UserRequirementsController.showDetailPopup(
                                      username!,
                                      context,
                                      ref,
                                      req,
                                          ...
                                          return Container(
                                            ...
                                            child: Tooltip(
                                              ...
                                              child: GestureDetector(
                                                onTap: () {
                                                  controller
                                                      .UserRequirementsController.showAttributeDialog(
                                                    context,
                                                    ref,
                                                    req.id,
                                                    h.header,
                                          ...
                                          child:
                                              isAdmin
                                                  ? IconButton(
                                                    ...
                                                    onPressed:
                                                        () => controller
                                                            .UserRequirementsController.toggleFlag(
                                                          req,
                                                          ref,
                                                        ),
                                                  )
